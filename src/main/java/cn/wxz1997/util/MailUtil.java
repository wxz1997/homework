...
public class MailUtil {
    ...
    public static String myEmailAccount = "951688320@qq.com";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    //public static String receiveMailAccount = "1047649886@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, String body) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "wxz1997", "UTF-8"));
